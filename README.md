...
<div class="tab-container">
  ...
  <div id="faq" class="tab-content">
    ...
    <div class="notification-box note">
      <div class="notification-title">Q: What do you have in Advanced Formatting tab on SillyTavern (Text Completion)?</div>
      <div class="notification-content">A: Nothing. If you're using Chat Completion Presets, none of the prompts from Advanced Formatting are sent.</div>
    </div>
...
<footer style="margin-top: 4rem; padding: 2rem 0 1.5rem 0; border-top: 2px solid var(--dottore-primary); background: linear-gradient(135deg, var(--dottore-dark) 0%, rgba(0, 224, 230, 0.05) 100%); text-align: center;">
  ...
  <div style="border-top: 1px solid rgba(0, 224, 230, 0.2); padding-top: 1rem; color: rgba(255, 255, 255, 0.7); font-size: 0.85rem;">
    <p>© MarinaraSpaghetti 2025</p>
    <p style="margin-top: 0.3rem;">✨ Created with the help of <strong style="color: var(--dottore-primary);">Claude Sonnet 4</strong></p>
  </div>
